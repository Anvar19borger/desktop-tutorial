...
public class SeasonAppl {
    public static void main(String[] args) {
        ...
        // .values()- beeret vse saganjaeet v massiv vs elimenti
        // .toString
        // .ordinal()
        // .valueOf()

        Season[] seasons = Season.values();// sanosim snacheenie enum  v massiv

        //  Season s1 = Season.WIN; mojno itak
        ...
        // for each
        for (Season s : seasons) {// periberaet polni masiv i ne kak inache
            System.out.println(s.getNumber());//uproschaet sintaksis
        }
