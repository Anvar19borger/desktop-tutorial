...
public class Supermarket {
    //polja klassa
    private Product[] products;// massiv tipa Product
    private int quantity;//tekuschie kolichestvo produktov v massive "na skladee"
    // konstructor

    public Supermarket(int capacity) {
        products = new Product[capacity];// sosdaem novi obekt
    }
    ...
    public boolean addProduct(Product product) {
        ...
        products[quantity] = product;//dobovljaem v kanec massiva
        quantity++;// uvelichivweem na 1
        return true;
    }
