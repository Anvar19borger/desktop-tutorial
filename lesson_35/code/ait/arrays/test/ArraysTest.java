...
import ait.solditer.model.Soldier;
...
public class ArraysTest {
    ...
    void setUp() {
        ...
        soldiers = new Soldier[]{
                ...
                new Soldier("Markus", 162, 55.1, 91),
                new Soldier("Mary", 159, 82.3, 91),
                new Soldier("Aysha", 162, 55, 88)
        };
    }

    @Test
    void testArraysSortComparator() {
        Arrays.sort(arrNum, (n1, n2) -> n2 - n1);// ot bolschego k menschemu
    ...
    void testSortSoldiersByName() {
        Arrays.sort(soldiers, (s1, s2) -> s1.getName().compareTo(s2.getName()));// Lamdo virojenie
        printArray(soldiers);
    }
