package hoework.doc_archive.dao;

import hoework.doc_archive.model.Document;
...
public class ArchiveImpl implements Archive{
    ...
    public boolean updateDocument(int folderId, int documentId, String url) {
        Document document = (Document) getDocFromFolder(folderId, documentId);
        if (document == null) {
            return false;
        }
        document.setUrl(url);
    ...
    @Override
    public Object getDocFromFolder(int folderId, int documentId) {
